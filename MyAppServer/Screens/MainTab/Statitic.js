      ...
      data: {
        dataSets: [{
          ...
          config: {
            ...
            stackLabels: ['Bag', 'BackPack', 'Wallet']
          }
        }],
      },
      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={{ height: 80 }}>
          <View style={{ justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
            <Text style={{ fontSize: 15, fontWeight: '700', color: '#f15929' }}> Bag</Text>
            <Image style={{ width: 50, height: 50 }} source={require('../../Assets/image/IconLogoBagPag.png')}></Image>
            <Text style={{ fontSize: 15, fontWeight: '700', color: '#f15929' }}> Pag</Text>
          </View>
